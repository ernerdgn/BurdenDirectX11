...
void RenderSystem::setRasterizerState(bool cull_front_flag)
{
	if (cull_front_flag) m_imm_context->RSSetState(m_rasterizer_cull_front_state);
	else m_imm_context->RSSetState(m_rasterizer_cull_back_state);
}
...
void RenderSystem::initRasterizerState()
{
	...
	m_d3d_device->CreateRasterizerState(&desc, &m_rasterizer_cull_front_state);

	//back
	desc.CullMode = D3D11_CULL_BACK;

	m_d3d_device->CreateRasterizerState(&desc, &m_rasterizer_cull_back_state);
}
